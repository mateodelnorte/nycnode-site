...
Meetup.add({
	...
	place: { type: String, required: false, initial: true, width: 'medium', default: 'Shutterstock, NYC', note: 'Shutterstock, NYC' },
	map: { type: String, required: false, initial: true, width: 'medium', default: 'Shutterstock, NYC', note: 'Shutterstock, NYC' },
